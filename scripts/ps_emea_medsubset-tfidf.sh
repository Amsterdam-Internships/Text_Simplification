...
then
    python src/extract_sentences.py --reference_file NMT-Data/reference_med.txt --output_path_en $opensubtitles_folder/opensubtitles_en_testing --output_path_nl $opensubtitles_folder/opensubtitles_nl_testing
else 
...
python3 src/data_processing/filter.py $opensubtitles_folder/opensubtitles_en_testing NMT-Data/Model_English_S_Dutch_S/opensubtitles_nl_testing en nl #filter opensubtitles
...
python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/opensubtitles_en_testing-filtered.en --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/yttm_source.model #train bpe for OpenSubtitles source
python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/opensubtitles_nl_testing-filtered.nl --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/yttm_target.model #train bpe for OpenSubtitles target
...
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/yttm_source.model --input_path NMT-Data/Model_English_S_Dutch_S/opensubtitles_en_testing-filtered.en --output_path NMT-Data/Model_English_S_Dutch_S/opensubtitles_en-filtered.en-subword.en #subword OpenSubtitles source
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/yttm_target.model --input_path NMT-Data/Model_English_S_Dutch_S/opensubtitles_nl_testing-filtered.nl --output_path NMT-Data/Model_English_S_Dutch_S/opensubtitles_nl-filtered.nl-subword.nl #subword Opensubtitles target
...
python3 src/data_processing/train_dev_test_split.py 2000 2000 $opensubtitles_folder/opensubtitles_en-filtered.en-subword.en NMT-Data/Model_English_S_Dutch_S/opensubtitles_nl-filtered.nl-subword.nl #split OpenSubtitles data
...
onmt_build_vocab -config config/model_en-nl_opensubtitles.yaml -overwrite True #build vocab
...
onmt_train -config config/model_en-nl_opensubtitles.yaml #-src_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.src -tgt_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.tgt #train OpenSubtitles Model
...
#model 3
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/yttm_source.model --input_path $wikisimple_folder/model_output/Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3
onmt_translate -ban_unk_token -model $opensubtitles_folder/model/mybasemodel_step_10000.pt -src NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3 -output $opensubtitles_folder/model_output/Model_3_pred.txt -verbose
python3 src/data_processing/3_desubword.py --model_path $opensubtitles_folder/subword_model/yttm_target.model --input_path $opensubtitles_folder/model_output/Model_3_pred.txt --output_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword

#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "error calc 5"
