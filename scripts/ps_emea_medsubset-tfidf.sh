...
then
    python scripts/extract_sentences.py --reference_file NMT-Data/reference_med.txt --output_path_en $opensubtitles_folder/opensubtitles_en_testing --output_path_nl $opensubtitles_folder/opensubtitles_nl_testing
else 
...
#Evaluate Results
python3 notebooks/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "error calc 5"
