...
#Preprocess data
python3 src/data_processing/filter.py $emea_folder/extended_emea.nl $emea_folder/extended_emea.en nl en #filter EMEA
...
python3 src/data_processing/1_train_bpe.py --train_data_path $emea_folder/extended_emea.nl-filtered.nl --model_path $emea_folder/subword_model/extended_source.model #train bpe for EMEA source
python3 src/data_processing/1_train_bpe.py --train_data_path $emea_folder/extended_emea.en-filtered.en --model_path $emea_folder/subword_model/extended_target.model #train bpe for EMEA target
...
#subword data
python3 src/data_processing/2_subword.py --model_path $emea_folder/subword_model/extended_source.model --input_path $emea_folder/extended_emea.nl-filtered.nl --output_path $emea_folder/extended_emea.nl-filtered.nl-subword.nl #subword EMEA source
python3 src/data_processing/2_subword.py --model_path $emea_folder/subword_model/extended_target.model --input_path $emea_folder/extended_emea.en-filtered.en --output_path $emea_folder/extended_emea.en-filtered.en-subword.en #subword EMEA target
...
python3 src/data_processing/train_dev_test_split.py 2000 2000 $emea_folder/extended_emea.nl-filtered.nl-subword.nl $emea_folder/extended_emea.en-filtered.en-subword.en #split EMEA data
...
#model 1
python3 src/data_processing/2_subword.py --model_path $emea_folder/subword_model/extended_source.model --input_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --output_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_1
...
python3 src/data_processing/3_desubword.py --model_path $emea_folder/subword_model/extended_target.model --input_path $emea_folder/model_output/Model_1_pred.txt --output_path $emea_folder/model_output/Model_1_pred.txt.desubword
...
#model 3
python3 src/data_processing/2_subword.py --model_path $emea_folder/subword_model/extended_target.model --input_path $wikisimple_folder/model_output/Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3
...
python3 src/data_processing/3_desubword.py --model_path $emea_folder/subword_model/extended_source.model --input_path $opensubtitles_folder/model_output/Model_3_pred.txt --output_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword

#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "Extended Emea Medical Pipeline"
