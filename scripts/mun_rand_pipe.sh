...
#1m samples from opensubtitles corpus
head -n 1000000 $opensubtitles_folder/OpenSubtitles.en-nl.nl > $opensubtitles_folder/openrand.nl
head -n 1000000 $opensubtitles_folder/OpenSubtitles.en-nl.en > $opensubtitles_folder/openrand.en
...
python3 notebooks/data_processing/filter.py $opensubtitles_folder/openrand.en $opensubtitles_folder/openrand.nl en nl #filter opensubtitles
...
python3 notebooks/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/openrand.en-filtered.en --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/mun_rand_source.model #train bpe for OpenSubtitles source
python3 notebooks/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/openrand.nl-filtered.nl --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/mun_rand_target.model #train bpe for OpenSubtitles target
...
python3 notebooks/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_rand_source.model --input_path NMT-Data/Model_English_S_Dutch_S/openrand.en-filtered.en --output_path NMT-Data/Model_English_S_Dutch_S/openrand.en-filtered.en-subword.en #subword OpenSubtitles source
python3 notebooks/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_rand_target.model --input_path NMT-Data/Model_English_S_Dutch_S/openrand.nl-filtered.nl --output_path NMT-Data/Model_English_S_Dutch_S/openrand.nl-filtered.nl-subword.nl #subword Opensubtitles target
...
python3 notebooks/data_processing/train_dev_test_split.py 2000 2000 NMT-Data/Model_English_S_Dutch_S/openrand.nl-filtered.nl-subword.nl NMT-Data/Model_English_S_Dutch_S/openrand.en-filtered.en-subword.en #split OpenSubtitles data
...
#OpenSubtitles
touch $opensubtitles_folder/run/mun_rand_vocab.src; #create empty files where vocab will be stored
touch $opensubtitles_folder/run/mun_rand_vocab.tgt;
onmt_build_vocab -config config/mun_rand_model_3.yaml -overwrite True #build vocab

#Train Models
#onmt_train -config config/mun_model_1.yaml #-src_vocab $emea_folder/run/.vocab.src -tgt_vocab $emea_folder/run/.vocab.tgt #Train Emea model
...
#onmt_train -config config/mun_rand_model_3.yaml #-src_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.src -tgt_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.tgt #train OpenSubtitles Model
...
#model 3
python3 notebooks/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_rand_source.model --input_path $wikisimple_folder/model_output/mun_Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Municipal/mun_NL_test_org_subword_3
onmt_translate -ban_unk_token -model $opensubtitles_folder/model/openrand_step_10000.pt -src NMT-Data/Eval_Municipal/mun_NL_test_org_subword_3 -output $opensubtitles_folder/model_output/mun_Model_3_pred.txt -verbose
python3 notebooks/data_processing/3_desubword.py --model_path $opensubtitles_folder/subword_model/mun_rand_target.model --input_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt --output_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword

#Evaluate Results
python3 notebooks/evaluate_script.py --source_path NMT-Data/Eval_Municipal/complex --reference_path NMT-Data/Eval_Municipal/simple --target_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword --chart_title "Municipal Pipeline with Random Opensubtitles Corpus"