...
python3 src/data_processing/filter.py $opensubtitles_folder/openrand.en $opensubtitles_folder/openrand.nl en nl #filter opensubtitles
...
python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/openrand.en-filtered.en --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/mun_rand_source.model #train bpe for OpenSubtitles source
python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/openrand.nl-filtered.nl --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/mun_rand_target.model #train bpe for OpenSubtitles target
...
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_rand_source.model --input_path NMT-Data/Model_English_S_Dutch_S/openrand.en-filtered.en --output_path NMT-Data/Model_English_S_Dutch_S/openrand.en-filtered.en-subword.en #subword OpenSubtitles source
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_rand_target.model --input_path NMT-Data/Model_English_S_Dutch_S/openrand.nl-filtered.nl --output_path NMT-Data/Model_English_S_Dutch_S/openrand.nl-filtered.nl-subword.nl #subword Opensubtitles target
...
python3 src/data_processing/train_dev_test_split.py 2000 2000 NMT-Data/Model_English_S_Dutch_S/openrand.nl-filtered.nl-subword.nl NMT-Data/Model_English_S_Dutch_S/openrand.en-filtered.en-subword.en #split OpenSubtitles data
...
#model 3
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_rand_source.model --input_path $wikisimple_folder/model_output/Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3
...
python3 src/data_processing/3_desubword.py --model_path $opensubtitles_folder/subword_model/mun_rand_target.model --input_path $opensubtitles_folder/model_output/Model_3_pred.txt --output_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword

#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "Medical Pipleline with Random subset from opensubtitles corpus"