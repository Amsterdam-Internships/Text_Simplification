...
onmt_build_vocab -config config/extended_med_1.yaml -overwrite True #Build vocab
...
#Train Models
#onmt_train -config config/extended_med_1.yaml #-src_vocab $emea_folder/run/.vocab.src -tgt_vocab $emea_folder/run/.vocab.tgt #Train Emea model
