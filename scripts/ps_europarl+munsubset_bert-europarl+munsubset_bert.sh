...
then
    python src/extract_sentences.py --reference_file NMT-Data/reference_mun.txt --output_path_en $opensubtitles_folder/munsubset.en --output_path_nl $opensubtitles_folder/munsubset.nl
else 
    echo "OpenSubtitles Municipal Subset already exists"
fi

#Preprocess data
#python3 src/data_processing/filter.py $europarl_folder/extended_europarl.nl $europarl_folder/extended_europarl.en nl en #filter EMEA
...
#python3 src/data_processing/filter.py $opensubtitles_folder/munsubset.en $opensubtitles_folder/munsubset.nl en nl #filter opensubtitles

#build subword models
#python3 src/data_processing/1_train_bpe.py --train_data_path $europarl_folder/extended_europarl.nl-filtered.nl --model_path $europarl_folder/subword_model/extended_source.model #train bpe for EMEA source
#python3 src/data_processing/1_train_bpe.py --train_data_path $europarl_folder/extended_europarl.en-filtered.en --model_path $europarl_folder/subword_model/extended_target.model #train bpe for EMEA target
...
#python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/munsubset.en-filtered.en --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/mun_yttm_source.model #train bpe for OpenSubtitles source
#python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/munsubset.nl-filtered.nl --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/mun_yttm_target.model #train bpe for OpenSubtitles target


#subword data
#python3 src/data_processing/2_subword.py --model_path $europarl_folder/subword_model/extended_source.model --input_path $europarl_folder/extended_europarl.nl-filtered.nl --output_path $europarl_folder/extended_europarl.nl-filtered.nl-subword.nl #subword EMEA source
#python3 src/data_processing/2_subword.py --model_path $europarl_folder/subword_model/extended_target.model --input_path $europarl_folder/extended_europarl.en-filtered.en --output_path $europarl_folder/extended_europarl.en-filtered.en-subword.en #subword EMEA target
...
#python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_yttm_source.model --input_path NMT-Data/Model_English_S_Dutch_S/munsubset.en-filtered.en --output_path NMT-Data/Model_English_S_Dutch_S/munsubset.en-filtered.en-subword.en #subword OpenSubtitles source
#python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_yttm_target.model --input_path NMT-Data/Model_English_S_Dutch_S/munsubset.nl-filtered.nl --output_path NMT-Data/Model_English_S_Dutch_S/munsubset.nl-filtered.nl-subword.nl #subword Opensubtitles target

#Split data into train/test/dev
#python3 src/data_processing/train_dev_test_split.py 2000 2000 $europarl_folder/extended_europarl.nl-filtered.nl-subword.nl $europarl_folder/extended_europarl.en-filtered.en-subword.en #split EMEA data
...
#python3 src/data_processing/train_dev_test_split.py 2000 2000 NMT-Data/Model_English_S_Dutch_S/munsubset.nl-filtered.nl-subword.nl NMT-Data/Model_English_S_Dutch_S/munsubset.en-filtered.en-subword.en #split OpenSubtitles data
...
#onmt_build_vocab -config config/model_nl-en_europarl+munsubset_bert.yaml.yaml -overwrite True #Build vocab
...
#model 1
python3 src/data_processing/2_subword.py --model_path $europarl_folder/subword_model/extended_source.model --input_path NMT-Data/Eval_Municipal/complex --output_path NMT-Data/Eval_Municipal/mun_complex_subword_1
...
python3 src/data_processing/3_desubword.py --model_path $europarl_folder/subword_model/extended_target.model --input_path $europarl_folder/model_output/mun_Model_1_pred.txt --output_path $europarl_folder/model_output/mun_Model_1_pred.txt.desubword
...
#model 3
python3 src/data_processing/2_subword.py --model_path $europarl_folder/subword_model/extended_target.model --input_path $wikisimple_folder/model_output/mun_Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Municipal/mun_NL_test_org_subword_3
...
python3 src/data_processing/3_desubword.py --model_path $europarl_folder/subword_model/extended_source.model --input_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt --output_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword

#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Municipal/complex --reference_path NMT-Data/Eval_Municipal/simple --target_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword --chart_title "Extended Europarl Pipe error calc $1"