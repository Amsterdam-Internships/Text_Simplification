...
#onmt_build_vocab -config config/model_3_emea.yaml -overwrite True #build vocab
...
#model 3
python3 notebooks/data_processing/2_subword.py --model_path $emea_folder/subword_model/yttm_target.model --input_path $wikisimple_folder/model_output/Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3
...
python3 notebooks/data_processing/3_desubword.py --model_path $emea_folder/subword_model/yttm_source.model --input_path $opensubtitles_folder/model_output/Model_3_pred.txt --output_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword

#Evaluate Results
python3 notebooks/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "Emea Mun Pipe"