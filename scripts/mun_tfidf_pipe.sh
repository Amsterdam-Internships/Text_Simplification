...
onmt_build_vocab -config config/mun_model_3.yaml -overwrite True #build vocab
...
#onmt_train -config config/mun_model_3.yaml #-src_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.src -tgt_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.tgt #train OpenSubtitles Model
...
#model 3
python3 notebooks/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_yttm_source.model --input_path $wikisimple_folder/model_output/mun_Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Municipal/mun_NL_test_org_subword_3
...
python3 notebooks/data_processing/3_desubword.py --model_path $opensubtitles_folder/subword_model/mun_yttm_target.model --input_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt --output_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword

#Evaluate Results
python3 notebooks/evaluate_script.py --source_path NMT-Data/Eval_Municipal/complex --reference_path NMT-Data/Eval_Municipal/simple --target_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword --chart_title "Municipal Pipeline Evaluation"