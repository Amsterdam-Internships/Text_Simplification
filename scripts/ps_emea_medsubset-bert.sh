...
then
    python src/extract_sentences.py --reference_file NMT-Data/reference_med.txt --output_path_en $opensubtitles_folder/medsubset_bert.en --output_path_nl $opensubtitles_folder/medsubset_bert.nl --encoding_method sentence_transformer
else 
    echo "OpenSubtitles Medical Subset (Bert) already exists"
fi
...
python3 src/data_processing/filter.py $opensubtitles_folder/medsubset_bert.en NMT-Data/Model_English_S_Dutch_S/medsubset_bert.nl en nl #filter opensubtitles
...
#python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/medsubset_bert.en-filtered.en --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/medbert_source.model #train bpe for OpenSubtitles source
#python3 src/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/medsubset_bert.nl-filtered.nl --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/medbert_target.model #train bpe for OpenSubtitles target
...
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/medbert_source.model --input_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.en-filtered.en --output_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.en-filtered.en-subword.en #subword OpenSubtitles source
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/medbert_target.model --input_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.nl-filtered.nl --output_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.nl-filtered.nl-subword.nl #subword Opensubtitles target
...
python3 src/data_processing/train_dev_test_split.py 2000 2000 $opensubtitles_folder/medsubset_bert.en-filtered.en-subword.en NMT-Data/Model_English_S_Dutch_S/medsubset_bert.nl-filtered.nl-subword.nl #split OpenSubtitles data
...
#OpenSubtitles
touch $opensubtitles_folder/run/medbert_vocab.src; #create empty files where vocab will be stored
touch $opensubtitles_folder/run/medbert_vocab.tgt;
onmt_build_vocab -config config/model_en-nl_medsubset_bert.yaml -overwrite True #build vocab
...
#onmt_train -config config/model_en-nl_medsubset_bert.yaml #-src_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.src -tgt_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.tgt #train OpenSubtitles Model
...
#model 3
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/medbert_source.model --input_path $wikisimple_folder/model_output/Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3
onmt_translate -ban_unk_token -model $opensubtitles_folder/model/medbert_step_10000.pt -src NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3 -output $opensubtitles_folder/model_output/Model_3_pred.txt -verbose
python3 src/data_processing/3_desubword.py --model_path $opensubtitles_folder/subword_model/medbert_target.model --input_path $opensubtitles_folder/model_output/Model_3_pred.txt --output_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword

#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "Medical Pipeline With Opensubtitles Bert Subset"
