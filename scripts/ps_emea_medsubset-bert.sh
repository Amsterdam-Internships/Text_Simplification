...
then
    python scripts/extract_sentences.py --reference_file NMT-Data/reference_med.txt --output_path_en $opensubtitles_folder/medsubset_bert.en --output_path_nl $opensubtitles_folder/medsubset_bert.nl --encoding_method sentence_transformer
else 
...
python3 notebooks/data_processing/filter.py $opensubtitles_folder/medsubset_bert.en NMT-Data/Model_English_S_Dutch_S/medsubset_bert.nl en nl #filter opensubtitles
...
#python3 notebooks/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/medsubset_bert.en-filtered.en --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/medbert_source.model #train bpe for OpenSubtitles source
#python3 notebooks/data_processing/1_train_bpe.py --train_data_path $opensubtitles_folder/medsubset_bert.nl-filtered.nl --model_path NMT-Data/Model_English_S_Dutch_S/subword_model/medbert_target.model #train bpe for OpenSubtitles target
...
python3 notebooks/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/medbert_source.model --input_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.en-filtered.en --output_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.en-filtered.en-subword.en #subword OpenSubtitles source
python3 notebooks/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/medbert_target.model --input_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.nl-filtered.nl --output_path NMT-Data/Model_English_S_Dutch_S/medsubset_bert.nl-filtered.nl-subword.nl #subword Opensubtitles target
...
#model 3
python3 notebooks/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/medbert_source.model --input_path $wikisimple_folder/model_output/Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org_subword_3
...
python3 notebooks/data_processing/3_desubword.py --model_path $opensubtitles_folder/subword_model/medbert_target.model --input_path $opensubtitles_folder/model_output/Model_3_pred.txt --output_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword

#Evaluate Results
python3 notebooks/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "Medical Pipeline With Opensubtitles Bert Subset"
