...
#onmt_build_vocab -config config/model_en-nl_europarl.yaml -overwrite True #build vocab

#Train Models
#onmt_train -config config/model_nl-en_europarl.yaml -src_vocab NMT-Data/europarl/run/ext_mun_vocab.src -tgt_vocab NMT-Data/europarl/run/ext_mun_vocab.tgt #Train Emea model
...
#onmt_train -config config/model_en-nl_europarl.yaml #-src_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.src -tgt_vocab NMT-Data/Model_English_S_Dutch_S/run/.vocab.tgt #train OpenSubtitles Model
...
#model 3
python3 src/data_processing/2_subword.py --model_path $europarl_folder/subword_model/yttm_target.model --input_path $wikisimple_folder/model_output/mun_Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Municipal/mun_NL_test_org_subword_3
...
python3 src/data_processing/3_desubword.py --model_path $europarl_folder/subword_model/yttm_source.model --input_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt --output_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword

#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Municipal/complex --reference_path NMT-Data/Eval_Municipal/simple --target_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword --chart_title "Europarl Pipeline (Europarl--> wikisimple --> Europarl)"