...
#model 3
python3 src/data_processing/2_subword.py --model_path $opensubtitles_folder/subword_model/mun_rand_source.model --input_path $wikisimple_folder/model_output/mun_Model_2_pred.txt.desubword --output_path NMT-Data/Eval_Municipal/mun_NL_test_org_subword_3
...
python3 src/data_processing/3_desubword.py --model_path $opensubtitles_folder/subword_model/mun_rand_target.model --input_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt --output_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword

#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Municipal/complex --reference_path NMT-Data/Eval_Municipal/simple --target_path $opensubtitles_folder/model_output/mun_Model_3_pred.txt.desubword --chart_title "Municipal Pipeline with Random Opensubtitles Corpus"