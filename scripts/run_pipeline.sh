...
then
    python src/extract_sentences.py --reference_file NMT-Data/reference_med.txt
...
#Evaluate Results
python3 src/evaluate_script.py --source_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_org --reference_path NMT-Data/Eval_Medical_Dutch_C_Dutch_S/NL_test_simp --target_path $opensubtitles_folder/model_output/Model_3_pred.txt.desubword --chart_title "Medical Pipeline Evaluation $1"
